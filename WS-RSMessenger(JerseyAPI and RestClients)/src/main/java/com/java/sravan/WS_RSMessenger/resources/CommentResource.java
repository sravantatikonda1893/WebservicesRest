...
import com.java.sravan.WS_RSMessenger.service.CommentService;
...
public class CommentResource {
	...
	@GET
	//This messageId property is comming from root resource which is in the url
	...
	@GET
	@Path("/commentId")
	//As the message id is already in the path we can get it directly
